      ...
      <main className="flex-grow">
        ...
        {currentView.type === "home" && homepageData && (
          <div>
            ...
            {/* Core Values Section */}
            <section className="py-12 bg-beige-paper/40 border-b border-beige-dark/30">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                  <div className="p-4 flex flex-col md:flex-row items-center md:items-start gap-4">
                    <div className="p-3 bg-clay-light text-clay rounded-full">
                      <Award className="w-7 h-7" />
                    </div>
                    <div>
                      <h4 className="font-serif font-bold text-base text-stone-charcoal mb-1">Nghệ Nhân Làng Nghề Cổ</h4>
                      <p className="text-xs text-stone-charcoal/70 font-sans">
                  ...
                  <div className="p-4 flex flex-col md:flex-row items-center md:items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-serif font-bold text-base text-stone-charcoal mb-1">Đá Tự Nhiên Nguyên Khối 100%</h4>
                      <p className="text-xs text-stone-charcoal/70 font-sans">
                  ...
                  <div className="p-4 flex flex-col md:flex-row items-center md:items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-serif font-bold text-base text-stone-charcoal mb-1">Thiết Kế Thước Lỗ Ban</h4>
                      <p className="text-xs text-stone-charcoal/70 font-sans">
